...
extern int __vmalloc_lock[1];
#define __malloc_lock __vmalloc_lock
__attribute__((__visibility__("hidden")))
extern const uint16_t vsize_classes[];
#define size_classes vsize_classes
...
__attribute__((__visibility__("hidden")))
extern struct malloc_context vctx;
#define ctx vctx
...
__attribute__((__visibility__("hidden")))
struct meta *alloc_vmeta(void);
#define alloc_meta alloc_vmeta

__attribute__((__visibility__("hidden")))
int is_vallzero(void *);
#define is_allzero is_vallzero

#define __lock __vlock
#define __unlock __vunlock
#define aligned_alloc valigned_alloc
#define __malloc_donate __vmalloc_donate
#define malloc_usable_size vmalloc_usable_size
