...
DEFAULT_WIDTH = 256 * 16
DEFAULT_HEIGHT = 256 * 16
...
def main(args):
    ...
    func = functools.partial(chaos.create_image_chaos, args.width,
            args.height, args.iterations, args.filename, args.rng_seed)
    do_bench('chaosgame', func, 5)
