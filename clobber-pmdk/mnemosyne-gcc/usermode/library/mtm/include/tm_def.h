...
TM_PURE __attribute__((noreturn)) 
...
TM_PURE int sprintf (char *__restrict __s, const char *__restrict __format, ...);

TM_PURE  __attribute__ ((__format__ (__printf__, 3, 4)))
int snprintf (char *__restrict __s, size_t __maxlen, const char *__restrict __format, ...);
TM_PURE int vsprintf (char *__restrict __s, const char *__restrict __fmt, __builtin_va_list __ap);
TM_PURE int vsnprintf (char *__restrict __s, size_t __n, const char *__restrict __fmt, __builtin_va_list __ap);
